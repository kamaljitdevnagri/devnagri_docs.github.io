...
If user has a existing account clik on Already login.
If new user click on not login button.

![dotalogin](./images/dotalogin.png)

## Signin page 
User has to provide the login id and password and click on signin.
...
Upon clicking on placeg order user has to selecte the plan details and update the project summary details. 

![price1](./images/abcd.png)


# payment 
user will redrected to the payment page and choose any payment method and add the transcations and confirm the order.
![pyment](./images/payment.png)

Order gets confirmed and page will naviagte to the Add Url page.
...
User can use this tab by pasting indivudally URL's. to crawl.
...
ex  Languages,Url's,Plan,Progress,word count,pagesview.
...
Proof read shows  all the sentances of the URL along with the translation .
...
User can seet all the progress of the translated URL's
...
If system did not crawal any url due to some techincal issue or user want only one particular URL to be translated so user can provide the URL and transalte the page.
...
User can see no.of visitors in the pageview.

![pageview](./images/Dotapageview.png)

# Total views 

User can see how how many users are visting his page it will reflect under the total views.
...
The list of PT orders will shown under orders page as type DOTA and Pemium translation page of DOTA dashboard.
...
Font size can increase and decreate with this button.
...
If User/transaltor want to save a particular sentence after any changes in sentence they will click on the save translation button.
...
If User wants to translate any praticular word he can create a rule for always translate.
